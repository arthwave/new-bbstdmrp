...
-- Available muzzle effects: rg_muzzle_grenade, rg_muzzle_highcal, rg_muzzle_pistol, rg_muzzle_rifle, rg_muzzle_silenced, none
...
SWEP.Instructions 		= "Buckshot Damage (Per buckshot lead): 7% \nSlug Damage (Per slug): 77% \nRecoil: 50% \nBuckshot Precision: 40% \nSlug Precision: 85% \nType: Pump-Action \n\nChange Mode: E + Right Click"
