...
function SWEP:PrimaryAttack()
	-- TDMRP VOLLEY SUFFIX: Block all M9K firing for Volley weapons
	-- Charging/firing handled entirely by TDMRP's Think hook
	if SERVER then
		local suffixId = self:GetNWString("TDMRP_SuffixID", "")
		if suffixId == "of_Volley" then
			return  -- Do NOT execute any M9K firing logic
		end
	end
