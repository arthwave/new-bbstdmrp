...
TEAM_RECON = DarkRP.createJob("Recon", {
    ...
    tdmrp_dt = 0,
    tdmrp_dt_name = "None",
    tdmrp_walk_speed = 300,         -- +50% of 200
    tdmrp_run_speed = 450,          -- +50% of 300
...
TEAM_MASTERCHIEF = DarkRP.createJob("Master Chief", {
    ...
    tdmrp_walk_speed = 240,         -- 120% of 200
    tdmrp_run_speed = 360,          -- 120% of 300
...
TEAM_YAMAKAZI = DarkRP.createJob("Yamakazi", {
    ...
    tdmrp_dt = 0,
    tdmrp_dt_name = "None",
    tdmrp_walk_speed = 320,         -- 160% of 200
    tdmrp_run_speed = 480,          -- 160% of 300
