----------------------------------------------------
-- tdmrp_m9k_ares_shrike
-- TDMRP Weapon: Ares Shrike
...
SWEP.Base = "m9k_ares_shrike"

SWEP.PrintName = "Ares Shrike"
SWEP.Category = "TDMRP LMGs"
SWEP.Spawnable = true
SWEP.AdminOnly = false

SWEP.TDMRP_ShortName = "SHRIKE"
SWEP.TDMRP_WeaponType = "lmg"
SWEP.TDMRP_BaseClass = "m9k_ares_shrike"
