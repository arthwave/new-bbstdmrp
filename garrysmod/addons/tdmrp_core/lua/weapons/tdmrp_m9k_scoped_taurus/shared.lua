----------------------------------------------------
-- tdmrp_m9k_scoped_taurus
-- TDMRP Weapon: Scoped Taurus
...
SWEP.Base = "m9k_scoped_taurus"

SWEP.PrintName = "Scoped Taurus"
SWEP.Category = "TDMRP Pistols"
SWEP.Spawnable = true
SWEP.AdminOnly = false

SWEP.TDMRP_ShortName = "TAURUS"
SWEP.TDMRP_WeaponType = "revolver"
SWEP.TDMRP_BaseClass = "m9k_scoped_taurus"
